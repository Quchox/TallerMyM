...
const ListarElimVehiculos = () => {
  ...
  const handleEditar = (idVehiculo) => {
    navigate(`/vehiculos/eliminar/${idVehiculo}`); // Redirige a la página de edición
  };
  ...
  return (
    <div className="p-6">
      <h1 className="text-2xl font-bold mb-4">Lista de Vehiculo7</h1>
...
export default ListarElimVehiculos;